...
exports.postAddProduct = (req, res, next) => {
    ...
    if(!errors.isEmpty())
    {
        return res.render('./admin/edit_product', {pageTitle : 'Add Product', path : '/admin/edit_product', editing :false, product :{title: title, image: image,price: price, author: author}, hasError: true, errorMessage: errors.array()[0].msg, validationErrors: errors.array()})
    }
...
exports.postEditProduct = (req, res, next) => {
    ...
    if(!errors.isEmpty())
    {
        return res.render('./admin/edit_product', {pageTitle : 'Edit Product', path : '/admin/edit_product', editing :true, product :{title: title, image: image,price: price, author: author, _id: id}, hasError: true, errorMessage: errors.array()[0].msg, validationErrors: errors.array()})
    }
